...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
{\bf \noindent Homework 1. \\ Due: Monday, September, 5 2022 before 8am EDT.}

\begin{problem}{(Jumping frog (II))}

{\bf (a) } Define the entries of your table in words.  E.g., $T(i)$ or $T(i,j)$ is~....

\vspace{3in}

{\bf (b) } State recurrence for entries of your table in
...
{\bf (d) } State and analyze the running time of your algorithm.
...
\begin{problem}{(Electoral colleges)}
